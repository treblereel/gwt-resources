...
public class StableObfuscationStyleTest extends RenamingClassNameTest {
  ...
  public void testClassesRenaming() {
    ...
    assertEquals("org-gwtproject-resources-client-gss-TestResources-ClassNameAnnotation-renamed" +
            "-class", renamedClass);
    assertEquals("org-gwtproject-resources-client-gss-TestResources-ClassNameAnnotation" +
