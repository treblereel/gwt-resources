...
public class Parser implements org.w3c.css.sac.Parser, ParserConstants {
  ...
  /**
   * Convert the source into a CharStream with encoding informations. The encoding can be found in
   * the InputSource or in the CSS document. Since this method marks the reader and make a reset
   * after looking for the charset declaration, you'll find the charset declaration into the stream.
   */
  private CharStream getCharStreamWithLurk(InputSource source) throws CSSException, IOException {
    if (source.getCharacterStream() != null) {
    ...
    source.setCharacterStream(
        new InputStreamReader(source.getByteStream(), Encoding.getJavaEncoding(encoding)));
      ...
      if (e instanceof ParseException) {
        ...
        if (pe.specialConstructor) {
          ...
          if (pe.currentToken != null) {
            errorM.append("encountered \"").append(pe.currentToken.next);
          }
          errorM.append('"');
          ...
          errorHandler.error(new CSSParseException(errorM.toString(), l, e));
        } else {
  ...
  public final void page() throws ParseException {
    ...
    try {
      ...
      if (errorHandler != null) {
        LocatorImpl li =
            new LocatorImpl(
                this, e.currentToken.next.beginLine, e.currentToken.next.beginColumn - 1);
        reportError(li, e);
        skipStatement();
  ...
  public final String pseudo_page() throws ParseException {
    Token n;
  ...
  public final void styleRule() throws ParseException {
    ...
    try {
      ...
      if (errorHandler != null) {
        LocatorImpl li =
            new LocatorImpl(
                this, e.e.currentToken.next.beginLine, e.e.currentToken.next.beginColumn - 1);
        reportError(li, e.e);
      }
    } catch (ParseException e) {
      reportError(getLocator(), e);
  ...
  public final Selector simple_selector(Selector selector, char comb) throws ParseException {
    ...
    if (selector != null) {
      switch (comb) {
        ...
        case '+':
          selector =
              selectorFactory.createDirectAdjacentSelector((short) 1, selector, simple_current);
          break;
        case '>':
    ...
    if (pseudoElt != null) {
      selector =
          selectorFactory.createChildSelector(
              selector, selectorFactory.createPseudoElementSelector(null, pseudoElt));
    }
    {
      if (true) return selector;
    }
  ...
  public final Condition pseudo(Condition pred) throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          ...
          if (pseudoElt != null) {
            {
              if (true)
                throw new CSSParseException(
                    "duplicate pseudo element definition " + s, getLocator());
            }
          } else {
            pseudoElt = s;
            {
      ...
      case FUNCTION:
        ...
        if (f.equals("lang(")) {
          Condition d = conditionFactory.createLangCondition(convertIdent(language.image));
          if (pred == null) {
            {
              if (true) return d;
            }
          ...
          {
            if (true)
              throw new CSSParseException("invalid pseudo function name " + f, getLocator());
          }
        }
        break;
      default:
  ...
  public final void declaration() throws ParseException {
    ...
    try {
      ...
      if (errorHandler != null) {
        errorHandler.error(
            new CSSParseException("Invalid number " + e.getMessage(), getLocator(), e));
      }
      reportWarningSkipText(getLocator(), skipAfterExpression());
    } catch (ParseException e) {
      if (errorHandler != null) {
      ...
      case FUNCTION:
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          case NUMBER:
            n = jj_consume_token(NUMBER);
            result =
                LexicalUnitImpl.createNumber(n.beginLine, n.beginColumn, prev, number(op, n, 0));
            break;
          case PERCENTAGE:
            n = jj_consume_token(PERCENTAGE);
            result =
                LexicalUnitImpl.createPercentage(
                    n.beginLine, n.beginColumn, prev, number(op, n, 1));
            break;
          case PT:
  ...
  public final LexicalUnitImpl function(char operator, LexicalUnitImpl prev) throws ParseException {
    ...
    if ("rgb(".equals(f)) {
      ...
      if ((l != null)
        ...
        {
          if (true)
            return LexicalUnitImpl.createAttr(
                l.getLineNumber(), l.getColumnNumber(), prev, l.getStringValue());
        }
      }
    ...
    }
    {
      if (true)
        return LexicalUnitImpl.createFunction(
            n.beginLine, n.beginColumn, prev, f.substring(0, f.length() - 1), params);
    }
    throw new Error("Missing return statement in function");
  }
    ...
    if (index == -1) {
      params =
          LexicalUnitImpl.createInteger(
              n.beginLine, n.beginColumn, params, Integer.parseInt(s, 16));
    } else {
      ...
      params =
          LexicalUnitImpl.createInteger(
              n.beginLine, n.beginColumn, params, Integer.parseInt(s1, 16));
      params =
          LexicalUnitImpl.createInteger(
              n.beginLine, n.beginColumn, params, Integer.parseInt(s2, 16));
    }

    {
      if (true) return LexicalUnitImpl.createUnicodeRange(n.beginLine, n.beginColumn, prev, params);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  public final LexicalUnitImpl hexcolor(LexicalUnitImpl prev) throws ParseException {
    ...
    if (s.length() == 3) {
      ...
      {
        if (true)
          throw new CSSParseException("invalid hexadecimal notation for RGB: " + s, getLocator());
      }
    }
    {
      if (true) return LexicalUnitImpl.createRGBColor(n.beginLine, n.beginColumn, prev, first);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  /**
   * The following functions are useful for a DOM CSS implementation only and are not part of the
   * general CSS2 parser.
   */
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      default:
        ...
        if (ret.charAt(0) == '@') {
          ...
          {
            if (true) throw new CSSParseException("unrecognize rule: " + ret, getLocator());
          }
        }
    }
  }
  ...
  private int jj_gen;
  private final int[] jj_la1 = new int[109];
  ...
  private static void jj_la1_0() {
    jj_la1_0 =
        new int[] {
          0x0, 0x62, 0x62, 0x0, 0x60, 0x2, 0x2, 0x2, 0x1340000, 0x60, 0x2, 0x60, 0x2, 0x0, 0x2, 0x0,
          0x2, 0x2, 0x2, 0x335f6a0, 0x335f6a0, 0x2, 0x4000, 0x2, 0x2, 0x2, 0x2, 0x0, 0x1000000, 0x2,
          0x0, 0x8000, 0x2, 0x0, 0x2, 0x2, 0x2, 0x2, 0x0, 0x8000, 0x2, 0x0, 0x2, 0x201f6a0, 0x2,
          0x2, 0x11000, 0x2, 0x11000, 0x11002, 0x2, 0x2, 0x0, 0x8000, 0x2, 0x0, 0x2, 0x4000, 0x2,
          0x2, 0x1240000, 0x1240000, 0x1240000, 0x1240000, 0x1240000, 0x1240000, 0x1240000,
          0x1240000, 0x1240000, 0x1240000, 0x1340000, 0x100000, 0x2, 0x2, 0xe00, 0x2, 0x0, 0x2,
          0xe00, 0x1000000, 0x2, 0x2, 0x0, 0x2, 0x0, 0x2, 0x2, 0x2, 0x24000, 0x27000, 0x24000,
          0x3000, 0x3000, 0x0, 0x0, 0x3000, 0x2, 0x2, 0x3000, 0x2, 0x1340000, 0x2, 0x2, 0x2, 0x0,
          0x8000, 0x2, 0x0, 0x2,
        };
  }
  ...
  private static void jj_la1_2() {
    jj_la1_2 =
        new int[] {
          ...
          0x0, 0xe00, 0xe00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x600, 0x0, 0x0, 0x0, 0x400, 0x200, 0x600, 0x0, 0x0, 0x600, 0x0, 0x0, 0x0, 0x0,
