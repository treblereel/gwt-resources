...
public class ConditionFactoryImpl implements ConditionFactory {
   ...
   * @param typeNode <code>true</code> if the list should contain only nodes of the same type
   *     (element, text node, ...).
   * @param type <code>true</code> true if the list should contain only nodes of the same node (for
   *     element, same localName and same namespaceURI).
  ...
  public AttributeCondition createAttributeCondition(
      String localName, String namespaceURI, boolean specified, String value) throws CSSException {
