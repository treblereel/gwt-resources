    ...
    public String createAssignment(TreeLogger logger, ResourceContext context, AptContext aptContext, ExecutableElement method)
        ...
        if (urlExpressions[1] == null) {
            ...
            sw.println(UriUtils.class.getName() + ".fromTrustedString("
                    + LocaleInfo.class.getCanonicalName() + "getCurrentLocale().isRTL() ?"
...
/*        try {
    ...
    /**
     * This is client that can be client across permutations for a given
     * ClientBundle .
     */
    ...
    static class ExternalImage extends DisplayedImage {
        ...
        public void render(TreeLogger logger, ResourceContext context,
            ...
            normalContentsFieldName = fields.define("String", "externalImage",
            ...
            if (isRtl) {
                ...
                rtlContentsFieldName = fields.define("String", "externalImage_rtl",
