...
public class GssCompactPrinter extends GssCodePrinter implements CssCompilerPass {
    ...
    public GssCompactPrinter(CssNode subtree, @Nullable CodeBuffer buffer, @Nullable GssSourceMapGenerator generator) {
    ...
    public GssCompactPrinter(CssTree tree, @Nullable CodeBuffer buffer, @Nullable GssSourceMapGenerator generator) {
    ...
    public boolean enterConditionalBlock(CssConditionalBlockNode node) {
        ...
        var10000.warning((new StringBuilder(0 + String.valueOf(var2).length() + String.valueOf(var3).length() + String.valueOf(var5).length())).append(var2).append(var3).append(var5).toString());
        return true;
    }
