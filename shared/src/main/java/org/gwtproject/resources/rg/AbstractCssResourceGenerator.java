...
public abstract class AbstractCssResourceGenerator extends AbstractResourceGenerator {
    ...
    protected void writeGetText(TreeLogger logger, ResourceContext context, ExecutableElement method, SourceWriter sw) throws UnableToCompleteException {
    ...
    protected void writeSimpleGetter(ExecutableElement methodToImplement, String toReturn, SourceWriter sw) {
        sw.print("public");
        sw.print(" ");
