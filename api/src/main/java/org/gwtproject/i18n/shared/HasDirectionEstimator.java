...
public interface HasDirectionEstimator {
   ...
   *
   * @param enabled Whether to enable direction estimation. If {@code true}, sets the {@link
   *     DirectionEstimator} object to a default {@code DirectionEstimator}.
   */
   ...
   *
   * @param directionEstimator The {@code DirectionEstimator} to be set. {@code null} means turning
   *     off direction estimation.
   */
