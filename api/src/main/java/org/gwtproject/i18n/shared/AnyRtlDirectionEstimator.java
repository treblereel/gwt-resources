...
public class AnyRtlDirectionEstimator extends DirectionEstimator {
  ...
  /**
   * Estimates the direction of a given string using the "any RTL" heuristic: the return value is
   * RTL if the string contains at least one RTL character. Otherwise, it is LTR.
   *
