...
public class SafeHtmlBidiFormatter extends BidiFormatterBase {
   ...
   * org.gwtproject.i18n.client.HasDirection.Direction, String, boolean)
   *
  ...
  /**
   * @see BidiFormatter#spanWrapWithKnownDir(
   * org.gwtproject.i18n.client.HasDirection.Direction, String, boolean, boolean)
   *
  ...
  /**
   * @see BidiFormatter#spanWrapWithKnownDir(
   * org.gwtproject.i18n.client.HasDirection.Direction, String)
   *
   * @param dir {@code str}'s direction
   * @param str The input string
   * @return Input string after applying the above processing.
