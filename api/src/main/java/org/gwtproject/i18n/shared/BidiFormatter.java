...
public class BidiFormatter extends BidiFormatterBase {
  ...
  /**
   * Like
   * {@link #spanWrapWithKnownDir(org.gwtproject.i18n.client.HasDirection.Direction, String, boolean, boolean)},
  ...
  /**
   * Like
   * {@link #unicodeWrapWithKnownDir(org.gwtproject.i18n.client.HasDirection.Direction, String, boolean, boolean)},
   * but assumes {@code isHtml} is false and {@code dirReset} is true.
   *
   * @param dir {@code str}'s direction
   * @param str The input string
