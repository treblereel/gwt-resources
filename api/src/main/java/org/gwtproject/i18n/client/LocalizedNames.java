...
public interface LocalizedNames {
  ...
  /**
   * @return a possibly empty array of region codes, ordered by the literate population speaking the
  ...
  /**
   * @return an array of region codes of currently valid countries, ordered according to the
   *     collating order of this locale.
   */
