...
public class NumberFormat {
    ...
    public static NumberFormat getGlobalCurrencyFormat() {
        throw new UnsupportedOperationException("getGlobalCurrencyFormat");
    }
    ...
    public static NumberFormat getPercentFormat() {
        throw new UnsupportedOperationException("getPercentFormat");
    }
    ...
    public static NumberFormat getScientificFormat() {
        throw new UnsupportedOperationException("getScientificFormat");
    ...
    public static NumberFormat getSimpleCurrencyFormat() {
        throw new UnsupportedOperationException("getSimpleCurrencyFormat");
    }
    ...
    private static CurrencyData lookupCurrency(String currencyCode) {
        throw new UnsupportedOperationException("lookupCurrency");
    }
    ...
    private static String toPrecision(double d, int digits) {
        return new JsNumber(d).toPrecision();
    }
