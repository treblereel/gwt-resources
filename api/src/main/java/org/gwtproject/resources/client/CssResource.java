 ...
 * com.google.gwt.core.client.GWT#create(Class)}. An example:
 *
 * <pre>
 ...
 * ClientBundle method declaration with {@link CssResource.NotStrict}, however this is only
...
public interface CssResource extends CssResourceBase {
     ...
     * the value of the imported type's com.google.gwt.resources.client.CssResource.ImportedWithPrefix} value.
     * <p>
     ...
     * </pre>
     * <p>
     * If the imported CssResource type is lacking an com.google.gwt.resources.client.CssResource.ImportedWithPrefix}
     ...
     * use use of the {@link CssResource.Import} annotation (e.g. {@code .FocusCss-focused
