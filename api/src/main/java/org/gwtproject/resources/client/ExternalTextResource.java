...
/**
 * Identical to {@link org.gwtproject.resources.client.TextResource}, except the contents of the
 * resource are not inlined into the compiled output. This is suitable for resources that are not
 * required as part of program initialization.
 */
@DefaultExtensions(value = {".txt"})
public interface ExternalTextResource extends ResourcePrototype {

  /**
   * Fetches a {@link org.gwtproject.resources.client.TextResource} and calls {@code callback} with
   * the result.
   *
