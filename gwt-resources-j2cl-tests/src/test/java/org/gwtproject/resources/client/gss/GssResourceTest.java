...
public class GssResourceTest extends RenamingClassNameTest {
  ...
  public void testSprite() {
    ...
    String expected =
        "{height:64px;width:64px;overflow:hidden;background:url("
            + res().someImageResource().getSafeUri().asString()
            + ") -0px -0px  no-repeat}";
  ...
  public void testResourceUrl() {
    ...
    String expected =
        "{cursor:url("
            + res().someDataResource().getSafeUri().asString()
            + ");"
  ...
  public void testConstant() {
    ...
    String expectedCss =
        "." + withConstant.classOne() + "{padding:" + withConstant.constantOne() + "}";
  ...
  public void testClassNameAnnotation() {
    ...
    String expectedCss =
        "." + css.renamedClass() + "{color:black}." + css.nonRenamedClass() + "{color:white}";
  ...
  public void testNotStrict() {
    ...
    String expectedCss =
        "." + notStrict.someClass() + "{color:black}.otherNotStrictClass{" + "color:white}";
  ...
  public void testGenKeyFrames() {
    ...
    String expectedCss =
        "@keyframes myframe{0%{top:0}to{top:200px}}@-webkit-keyframes myframe{0%{top:0}to{top:200px}}"
