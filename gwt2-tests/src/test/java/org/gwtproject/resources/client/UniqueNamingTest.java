...
public class UniqueNamingTest extends GWTTestCase {
  ...
  public void testUniqueNaming() {
    OuterA.BundleHolder.Resources outerAResources = new UniqueNamingTest_OuterA_BundleHolder_ResourcesImpl();
    OuterB.BundleHolder.Resources outerBResources = new UniqueNamingTest_OuterB_BundleHolder_ResourcesImpl();
