...
public class DebugObfuscationStyleTest extends RenamingClassNameTest {
  ...
  public String getModuleName() {
    return "org.gwtproject.resources.GssDebugStyle";
  }
  ...
  public void testClassesRenaming() {
    ...
    assertTrue(
        renamedClass.matches(
            OBFUSCATION_PATTERN + "-TestResources-ClassNameAnnotation-renamed-class"));
    assertTrue(
        nonRenamedClass.matches(
            OBFUSCATION_PATTERN + "-TestResources-ClassNameAnnotation-nonRenamedClass"));
  }
}
