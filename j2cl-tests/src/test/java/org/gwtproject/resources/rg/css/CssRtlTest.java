...
/** This is a static test of the automatic RTL support. TODO inject APTContext to fix this test */
public class CssRtlTest {
  /* extends CssTestCase {
  ...
  private CssVisitor[] makeVisitors() {
      return new CssVisitor[]{new RtlVisitor(), new CssTestCase.AliasDetector()};
  }
